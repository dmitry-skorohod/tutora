...
return [
    ...
    'profile' => [
        ...
        'video' => [
            'record' => [
                'heading'      => 'Create your own presentation video',
                'introduction' => 'Here you can record a short x-minute clip that will be visible to your students!'
            ],
            'edit'   => [
                'heading'      => 'Re-record or delete your current video',
                'introduction' => 'If you need to delete your video or a better one, take action below.'
            ]
        ]
